...
def extract_paragraph_with_fact(article_body: str, fact_text: str) -> Optional[str]:
    ...
    for para in paragraphs:
        ...
        if fact_text in para_text:
            print(f"Found paragraph with the exact fact")
            return para_text
    ...
    if title and fact:
        ...
        if article:
            ...
            if original_paragraph:
                ...
                result['_meta'] = {'error': 'Original paragraph not found in article body'}
        else:
            ...
            try:
                ...
                for article in processed_articles:
                    ...
                    if article['OriginalParagraph']:
                        ...
                        entry_output += f"# Original paragraph not found\n\n"
