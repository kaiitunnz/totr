...
def transform_entry(entry):
    ...
    transformed += f"Q: Answer the following question.\n{entry.get('query', 'No query')}\n"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Transform JSON data to context-Q&A format')
    parser.add_argument('input_file', help='Path to input JSON file')
    parser.add_argument('--output', '-o', default='transformed_output.txt', 
